...
dependencies {
    ...
    implementation 'io.github.airwallex:payment-card:6.2.6'        // Card payments
    implementation 'io.github.airwallex:payment-redirect:6.2.6'    // Redirect-based payments
    implementation 'io.github.airwallex:payment-wechat:6.2.6'      // WeChat Pay
    implementation 'io.github.airwallex:payment-googlepay:6.2.6'   // Google Pay
}
```
...
```groovy
    dependencies {
       ...
       implementation 'io.github.airwallex:payment-card:6.2.6'//only support card
       implementation 'io.github.airwallex:payment-googlepay:6.2.6'//only support google pay
       implementation 'io.github.airwallex:payment-redirect:6.2.6'//only support redirect
    }
```
