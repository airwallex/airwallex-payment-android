...
dependencies {
    ...
    implementation 'io.github.airwallex:payment:6.2.2'
    
    // Add payment methods you want to support
    implementation 'io.github.airwallex:payment-card:6.2.2'        // Card payments
    implementation 'io.github.airwallex:payment-redirect:6.2.2'    // Redirect-based payments
    implementation 'io.github.airwallex:payment-wechat:6.2.2'      // WeChat Pay
    implementation 'io.github.airwallex:payment-googlepay:6.2.2'   // Google Pay
}
```
...
```groovy
    dependencies {
        // It's required
        implementation 'io.github.airwallex:payment-components-core:6.2.2'

       // Select the payment method you want to support, ignore the components you don't need.
       implementation 'io.github.airwallex:payment-card:6.2.2'//only support card
       implementation 'io.github.airwallex:payment-googlepay:6.2.2'//only support google pay
       implementation 'io.github.airwallex:payment-redirect:6.2.2'//only support redirect
    }
```
