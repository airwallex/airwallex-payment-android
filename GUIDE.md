...
dependencies {
    ...
    implementation 'io.github.airwallex:payment-card:6.2.7'        // Card payments
    implementation 'io.github.airwallex:payment-redirect:6.2.7'    // Redirect-based payments
    implementation 'io.github.airwallex:payment-wechat:6.2.7'      // WeChat Pay
    implementation 'io.github.airwallex:payment-googlepay:6.2.7'   // Google Pay
}
```
...
```groovy
    dependencies {
       ...
       implementation 'io.github.airwallex:payment-card:6.2.7'//only support card
       implementation 'io.github.airwallex:payment-googlepay:6.2.7'//only support google pay
       implementation 'io.github.airwallex:payment-redirect:6.2.7'//only support redirect
    }
```
