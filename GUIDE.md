...
```groovy
    dependencies {
        ...
        implementation 'io.github.airwallex:payment-card:4.4.1'
        implementation 'io.github.airwallex:payment-redirect:4.4.1'
        implementation 'io.github.airwallex:payment-wechat:4.4.1'
        implementation 'io.github.airwallex:payment-googlepay:4.4.1'
    }
```
