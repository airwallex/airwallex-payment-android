...
```groovy
    dependencies {
        // It's required
        implementation 'io.github.airwallex:payment:4.4.4'
        
        // Select the payment method you want to support.
        implementation 'io.github.airwallex:payment-card:4.4.4'
        implementation 'io.github.airwallex:payment-redirect:4.4.4'
        implementation 'io.github.airwallex:payment-wechat:4.4.4'
        implementation 'io.github.airwallex:payment-googlepay:4.4.4'
    }
```
