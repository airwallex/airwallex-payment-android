...
dependencies {
    ...
    implementation 'io.github.airwallex:payment:6.2.1'
    
    // Add payment methods you want to support
    implementation 'io.github.airwallex:payment-card:6.2.1'        // Card payments
    implementation 'io.github.airwallex:payment-redirect:6.2.1'    // Redirect-based payments
    implementation 'io.github.airwallex:payment-wechat:6.2.1'      // WeChat Pay
    implementation 'io.github.airwallex:payment-googlepay:6.2.1'   // Google Pay
}
```
...
```groovy
    dependencies {
        // It's required
        implementation 'io.github.airwallex:payment-components-core:6.2.1'

       // Select the payment method you want to support, ignore the components you don't need.
       implementation 'io.github.airwallex:payment-card:6.2.1'//only support card
       implementation 'io.github.airwallex:payment-googlepay:6.2.1'//only support google pay
       implementation 'io.github.airwallex:payment-redirect:6.2.1'//only support redirect
    }
```
