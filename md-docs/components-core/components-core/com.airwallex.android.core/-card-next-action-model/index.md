...
| Name | Summary |
|---|---|
| [activityProvider](activity-provider.md) | [androidJvm]<br>val [activityProvider](activity-provider.md): () -&gt; [ComponentActivity](https://developer.android.com/reference/kotlin/androidx/activity/ComponentActivity.html) |
...
| [locale](locale.md) | [androidJvm]<br>val [locale](locale.md): [Locale](https://developer.android.com/reference/kotlin/java/util/Locale.html)? = null |
