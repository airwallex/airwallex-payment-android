...
| [locale](locale.md) | [androidJvm]<br>open override val [locale](locale.md): [Locale](https://developer.android.com/reference/kotlin/java/util/Locale.html)? = null<br>Locale used by Airwallex-owned UI. `null` inherits the host application's current locale. |
