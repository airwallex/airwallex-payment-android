//[components-core](../../../index.md)/[com.airwallex.android.core.exception](../index.md)/[PermissionException](index.md)

# PermissionException

[androidJvm]\
class [PermissionException](index.md)(val error: [AirwallexError](../../com.airwallex.android.core.model/-airwallex-error/index.md), traceId: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)? = null) : [AirwallexException](../-airwallex-exception/index.md)

## Constructors

| | |
|---|---|
| [PermissionException](-permission-exception.md) | [androidJvm]<br>constructor(error: [AirwallexError](../../com.airwallex.android.core.model/-airwallex-error/index.md), traceId: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)? = null) |
