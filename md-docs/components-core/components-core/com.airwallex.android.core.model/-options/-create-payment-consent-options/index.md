//[components-core](../../../../index.md)/[com.airwallex.android.core.model](../../index.md)/[Options](../index.md)/[CreatePaymentConsentOptions](index.md)

# CreatePaymentConsentOptions

[androidJvm]\
data class [CreatePaymentConsentOptions](index.md)(val clientSecret: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html), request: [PaymentConsentCreateRequest](../../-payment-consent-create-request/index.md)) : [Options](../index.md)

## Constructors

| | |
|---|---|
| [CreatePaymentConsentOptions](-create-payment-consent-options.md) | [androidJvm]<br>constructor(clientSecret: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html), request: [PaymentConsentCreateRequest](../../-payment-consent-create-request/index.md)) |
