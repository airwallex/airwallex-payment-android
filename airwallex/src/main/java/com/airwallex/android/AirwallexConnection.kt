 ...
 * resources.
 */
internal class AirwallexConnection internal constructor(
    ...
    internal val response: AirwallexResponse
        @Throws(IOException::class)
        @JvmSynthetic
        get() {
            // trigger the request
            val responseCode = this.responseCode
            return AirwallexResponse(responseCode, responseBody, conn.headerFields)
        }
