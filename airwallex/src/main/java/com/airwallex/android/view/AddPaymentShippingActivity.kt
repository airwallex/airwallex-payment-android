...
class AddPaymentShippingActivity : AirwallexActivity() {

    private val args: AddPaymentShippingActivityStarter.ShippingArgs by lazy {
        AddPaymentShippingActivityStarter.ShippingArgs.getExtra(intent)
    }
