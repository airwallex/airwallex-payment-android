...
enum class CardBrand(
    ...
    Visa(
        type = "visa",
        icon = R.drawable.airwallex_ic_visa,
        prefixes = setOf("4"),
    ),
    MasterCard(
        type = "mastercard",
        icon = R.drawable.airwallex_ic_mastercard,
        prefixes = setOf(
    ...
    Amex(
        type = "amex",
        icon = R.drawable.airwallex_ic_amex,
    ...
    JCB(
        type = "jcb",
        icon = R.drawable.airwallex_ic_jcb,
        prefixes = setOf("3528", "3529", "353", "354", "355", "356", "357", "358"),
    ),
    DISCOVER(
        type = "discover",
        icon = R.drawable.airwallex_ic_discover,
        prefixes = setOf("6011", "644", "645", "646", "647", "648", "649", "65"),
        lengths = setOf(16, 19),
    ),
    DINERS(
        type = "diners",
        icon = R.drawable.airwallex_ic_diners,
    ...
    Unknown(
        type = "unknown",
        icon = R.drawable.airwallex_ic_card_default,
    );
