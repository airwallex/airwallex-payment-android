...
class PaymentUIIntegrationActivity : AppCompatActivity() {

    private val viewBinding: ActivityUiIntegrationBinding by lazy {
        ActivityUiIntegrationBinding.inflate(layoutInflater)
    }
    ...
    companion object {
        ...
        fun startActivity(context: Context) {
            context.startActivity(Intent(context, PaymentUIIntegrationActivity::class.java))
        }
    }
}
