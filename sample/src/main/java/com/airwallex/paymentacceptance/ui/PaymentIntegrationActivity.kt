...
import com.airwallex.paymentacceptance.databinding.ActivityPaymentIntegrationBinding
...
class PaymentIntegrationActivity : AppCompatActivity() {
    ...
    private lateinit var viewBinding: ActivityPaymentIntegrationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        viewBinding = ActivityPaymentIntegrationBinding.inflate(layoutInflater)
