...
dependencies {
    // 必须
    implementation 'io.github.airwallex:payment:6.8.0'
    // 按需添加支付方式
    implementation 'io.github.airwallex:payment-card:6.8.0'
    implementation 'io.github.airwallex:payment-redirect:6.8.0'
    implementation 'io.github.airwallex:payment-wechat:6.8.0'
    implementation 'io.github.airwallex:payment-googlepay:6.8.0'
}
```
...
dependencies {
    // 必须
    implementation 'io.github.airwallex:payment-components-core:6.8.0'
    // 按需添加支付方式
    implementation 'io.github.airwallex:payment-card:6.8.0'
    implementation 'io.github.airwallex:payment-googlepay:6.8.0'
    implementation 'io.github.airwallex:payment-redirect:6.8.0'
