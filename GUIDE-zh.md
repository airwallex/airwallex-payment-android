...
dependencies {
    ...
    // 按需添加支付方式
    implementation 'io.github.airwallex:payment-card:6.3.0'
    implementation 'io.github.airwallex:payment-redirect:6.3.0'
    implementation 'io.github.airwallex:payment-wechat:6.3.0'
    implementation 'io.github.airwallex:payment-googlepay:6.3.0'
}
```
