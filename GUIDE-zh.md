...
```groovy
    dependencies {
        ...
        implementation 'io.github.airwallex:payment-card:4.2.2'
        implementation 'io.github.airwallex:payment-redirect:4.2.2'
        implementation 'io.github.airwallex:payment-wechat:4.2.2'
        implementation 'io.github.airwallex:payment-googlepay:4.2.2'
    }
```
