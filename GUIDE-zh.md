...
```groovy
    dependencies {
        // It's required
        implementation 'io.github.airwallex:payment:6.0.7'
        
        // Select the payment method you want to support.
        implementation 'io.github.airwallex:payment-card:6.0.7'
        implementation 'io.github.airwallex:payment-redirect:6.0.7'
        implementation 'io.github.airwallex:payment-wechat:6.0.7'
        implementation 'io.github.airwallex:payment-googlepay:6.0.7'
    }
```
...
```groovy
    dependencies {
        // It's required
        implementation 'io.github.airwallex:payment-components-core:6.0.7'
        
        // Select the payment method you want to support, ignore the components you don't need.
        implementation 'io.github.airwallex:payment-card:6.0.7'//only support card
        implementation 'io.github.airwallex:payment-googlepay:6.0.7'//only support google pay
        implementation 'io.github.airwallex:payment-redirect:6.0.7'//only support redirect
    }
```
