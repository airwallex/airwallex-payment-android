...
dependencies {
    ...
    // 按需添加支付方式
    implementation 'io.github.airwallex:payment-card:6.2.1'
    implementation 'io.github.airwallex:payment-redirect:6.2.1'
    implementation 'io.github.airwallex:payment-wechat:6.2.1'
    implementation 'io.github.airwallex:payment-googlepay:6.2.1'
}
```
