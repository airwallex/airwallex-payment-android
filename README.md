...
dependencies {
    ...
    implementation 'io.github.airwallex:payment-card:6.8.0'        // Card payments
    implementation 'io.github.airwallex:payment-redirect:6.8.0'    // Redirect-based payments
    implementation 'io.github.airwallex:payment-wechat:6.8.0'      // WeChat Pay
    implementation 'io.github.airwallex:payment-googlepay:6.8.0'   // Google Pay
}
```
...
```groovy
    dependencies {
       ...
       implementation 'io.github.airwallex:payment-card:6.8.0'//only support card
       implementation 'io.github.airwallex:payment-googlepay:6.8.0'//only support google pay
       implementation 'io.github.airwallex:payment-redirect:6.8.0'//only support redirect
    }
```
